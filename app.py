...
DB_PASSWORD = os.getenv("DB_PASSWORD", "Darshan@2003")
DB_NAME = os.getenv("DB_NAME", "School_Collage")
RUN_DB_SETUP = os.getenv("RUN_DB_SETUP", "0" if os.getenv("VERCEL") else "1").lower() not in ("0", "false", "no")
